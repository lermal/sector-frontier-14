...
ent-WeaponSubMachineGunKnallstock = LWC Knallstock (9x19mm/.45 ACP)
    .desc = Прочный и надежный пистолет-пулемет, стреляющий крупными очередями с высокой скоростью. Подходит для пистолетных магазинов калибра 9x19 или .45 ACP. Следите за расходом патронов.

ent-WeaponSubMachineGunTypewriterPMC = PA Keyboard (.45 ACP)
    .desc = Современная интерпретация классического дизайна, используемого гангстерами во всех временах и пространствах. Это небрендовая версия наемника под названием «клавиатура», ствол которой быстро нагревается, что снижает точность. Использует патроны калибра .45 ACP.
